 ...
 * Use the [AllNormal.newInstance] factory method to
 * create an instance of this fragment.
 */
class AllNormal : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_all_normal, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.bChange).apply {
            setOnClickListener {
                ...
                findNavController().navigate(R.id.action_allNormal_to_allElder)
        ...
        view.findViewById<Button>(R.id.bReload).apply {
            setOnClickListener {
                AllElder.Companion.WeatherTask(view, city, api, lang).execute()
    ...
    companion object {
         ...
         * @return A new instance of fragment AllNormal.
         */
